import 'package:client/screens/card_interface_no_chips.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';
import 'dart:async';
import 'package:auto_size_text/auto_size_text.dart';
import 'savings_entry_model.dart';

class SavingsScreen extends StatefulWidget {
  _SavingsScreen createState() => _SavingsScreen();
}

class _SavingsScreen extends State<SavingsScreen> {
  ...
  Future<List<Transactions>> fetchNotes() async {
    ...
    if (response.statusCode == 200) {
      ...
      for (var noteJson in notesJson) {
        ...
        if(amountSpent != null)
          totalSaved+=amountSpent.toDouble();
      ...
      child: Column(
        children: <Widget>[
          Container(
            ...
            child: CardInterfaceW(totalSpent: totalSaved,),
